...
pas_pos = 1;
for (str_pos = 1; str_pos <= str_len; str_pos += 1) { // For each character in the string to be encrypted
 // Read the character to be encrypted & the password character to encrypt with
 ...
 str = string_insert(str_char,str,str_pos); // Replace with new encrypted character
